...
<template>
  <div class="inbox-body">
    <div class="mail-option">
      <button @click="navigateBack" class="btn btn-primary">
        <i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp; Back
      </button>
      <button @click="data.message.isDeleted = true" :isDisable="data.message.isDeleted" class="btn btn-danger">
    ...
    <p>
      <strong>From:</strong> {{ data.message.from.name }} &lt;{{ data.message.from.email }}&gt;
    </p>
    <hr>
...
export default {
  ...
  methods: {
    navigateBack() {
      ...
      eventBus.$emit('changeView', previousView)
    }
  },
}
</script>
